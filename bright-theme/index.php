...
<html lang="en">
    <head>
      <link rel="stylesheet" type="text/css" href="mod/bright-theme/css/style.css" />
       </head>
 <body>
		<div>
	<img src="mod/bright-theme/graphics/index.jpg" width="100%" height="100%" alt="Background"/>

			<div class="ac_loading"></div>
		</div><div class="topright">
  <?php include("mod/bright-theme/form.php"); ?>
		...
		<script type="text/javascript" src="mod/bright-theme/js/jquery.easing.1.3.js"></script>
